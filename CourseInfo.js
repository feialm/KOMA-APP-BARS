...
var myData = [
    {
        "id": "TNA004",  //KLAR
        "label": "Analys2",
        "value": 876, //rec min, totala tiden  //KLAR
        "addedTime": 110, //gjort min idag //KLAR
        "totAddedTime":110, //gjort totalt  //KLAR
        "color": "#f92672",   //KLAR
...
function hour_donut_text(myData) { //Måste ändra vad myData[0]. är för nått
  ...
  var hour_worked = (myData[0].value)/ 60;
