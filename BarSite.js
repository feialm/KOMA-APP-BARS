...
function ActivityInfo(HHH) {
  const a = HHH.a;
console.log("Min kärlek")   
   console.log(a) 
   console.log("ska brinna")
  ...
  <div className="WrapperActivity" >
   { /* <div className="WrapperActivity"  onClick={() => <BarSite sendObject={a}/>}> */ }

   {console.log("all i want for christmas is for this shit to work")}
   {console.log(a)}
...
function handleClickActivity(HHH) {
...
/*renderar sidelementen typ*/
  function BarSite(HHH) {
    // test
    const [ToCourseInfo, setToCourseInfo] = useState(handleClickActivity());

    
   console.log("Datanjang");
   console.log(ToCourseInfo);
  console.log("Mazzarin");
    
    //setToCourseInfo(handleClickActivity()); 
    i = 0;
    var HHH = loadData();
