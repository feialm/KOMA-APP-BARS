...
function create_fake_array_two(){
let myData = loadData();
var dayDiff_nbr = days_tot(myData)

var dayDiff_per = day_span(myData)

if(((myData[0].value)-(myData[0].totTime))<0){
  var recomend_left = 0
    ...
    <div className="App">
        ...
        <div id="wrapper">
         ...
         <div className="divButtonCourseInfo">
            <button onClick={() =>( myData[0].id, myData[0].startDate,myData[0].endDate,myData[0].value)} className="reportButton_CourseInfo stack center">
               <p className="buttonText" id="reportButtonText">Report time</p>
            </button>
          
            <button onClick={() =>( myData[0].id, myData[0].startDate,myData[0].endDate,myData[0].value)} className="editButton stack center">
