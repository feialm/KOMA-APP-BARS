        ...
        <div className="wrapperAddActivity fitText">
          ...
          <div className="wrapperDate">
            <div className="wrapperStartDate"> 
              ...
              <input className="dateBox" id="startDate" type="text" placeholder="mmddyy" onChange={changeInput}/>
            </div>
            <div className="wrapperEndDate">
              <p className="addActivityText">End Date</p>
              <input className="dateBox" id="endDate" type="text" placeholder="mmddyy" onChange={changeInput}/>
            </div>
          </div>
